        ...
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
            <div className="relative ">
              <h1 className="mx-auto text-9xl tracking-tighter-less text-shadow font-sans font-bold">
                <span>{error?.status ?? '404'}</span>
              </h1>
              <span className="absolute -top-8 text-gray-300 font-semibold">Oops!</span>
            </div>
            <h5 className="text-gray-300 font-semibold">{error.statusText}</h5>
